...
When editing or generating hero content:

- Lead with **general contracting and residential renovations**
- Keep language minimal, declarative, and factual
- Avoid slogans, clever phrasing, or novelty framing
- Do not include statistics in the hero
- Do not reference specialty features in the headline or subhead

The hero should feel like a calm statement of capability, not a sales pitch.
...
- Over-explaining competence
- Exclamation points or emojis

Tone should match how a trusted GC speaks during an initial walkthrough.
...
- If existing copy is already precise and restrained, **do not rewrite**
- Prefer subtraction over addition
- One idea per sentence
- Let clarity and structure carry authority, not adjectives
...
Helix Craftworks communicates through competence, not hype.
...
> “Does this sound like someone I’d trust to run my entire renovation?”

If yes, keep it.  
If it sounds like marketing, simplify or remove.
...
Helix Craftworks does not need to convince.  
