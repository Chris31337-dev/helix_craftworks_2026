...
const deliverySnapshots = [
  {
    ...
    description:
      'Renovations managed with clear sequencing, documented scope, and steady oversight from start to finish.',
    stats: [
  ...
  },
  {
    ...
    description:
      'Layouts, materials, and details are locked before work begins so installs move cleanly and predictably.',
    stats: [
  ...
  },
  {
    ...
    description:
      'Active job sites are protected, organized, and reset daily so homeowners can live comfortably during renovations.',
    stats: [
  ...
  },
  {
    ...
    description:
      'Trim, cabinetry, and transitions installed with tight tolerances and an eye for alignment.',
    stats: [
  ...
  },
  {
    ...
    description:
      'Clients receive consistent updates and a single point of contact throughout the project.',
    stats: [
  ...
  },
  {
    ...
    description:
      'Specialty features like hidden doors and complex millwork are integrated seamlessly within larger renovation scopes.',
    stats: [
  ...
  },
  {
    ...
    description:
      'Many clients return for additional rooms or future projects after the first renovation is complete.',
    stats: [
    ...
    <div className="grid gap-4 sm:grid-cols-2">
      {snapshot.stats.map((item) => (
        <div
          ...
          className="rounded-xl border border-canvas/10 bg-charcoal/60 p-4 shadow-glow/30"
        >
  ...
  return (
    <>
      {services.map((service) => (
        <article
          key={service.title}
          className="rounded-2xl border border-canvas/10 bg-canvas/5 p-6 shadow-card shadow-glow/40"
        >
          ...
          <a
            href={service.href}
            className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-redwood"
          >
            <span>Explore</span>
  ...
  return (
    <>
      {steps.map((step) => (
        <article
          key={step.title}
          className="rounded-2xl border border-canvas/10 bg-canvas/5 p-5 shadow-card"
        >
...
const standalonePages: Partial<Record<string, StandalonePage>> = {
  '/renovations': {
    title: 'Renovations & Remodels',
    intro:
      'Full-scope residential renovations managed end to end, from early planning and permits through final inspection and close-out.',
    sections: [
      {
        heading: 'What we manage',
        items: [
          'Planning, permits, and inspections',
          'Sequenced trades with documented scope',
          'Site protection, dust control, and finish alignment',
        ],
      },
      {
        heading: 'How we deliver',
        items: [
          'Clear schedule and milestone tracking',
          'Material approvals before demo',
          'Daily oversight until handoff',
        ],
      },
    ],
  },
  '/general-contracting': {
    title: 'General Contracting',
    intro:
      'Scheduling, sequencing, and trade coordination handled directly to keep scope, budget, and finish quality aligned throughout the build.',
    sections: [
      {
        heading: 'Controls in place',
        items: [
          'Single point of contact from start to finish',
          'Approved scopes before mobilization',
      ...
      },
      {
        heading: 'Oversight',
        items: [
          'On-site checks during critical phases',
          'Issue resolution before it impacts schedule',
          'Close-out with documented punch completion',
        ],
      },
    ],
  },
  '/finish-carpentry-millwork': {
    title: 'Finish Carpentry & Millwork',
    intro:
      'Trim, paneling, built-ins, and architectural details executed with tight tolerances and alignment to the existing home.',
    sections: [
      {
        heading: 'Focus areas',
        items: [
          'Casing, crown, and panel systems set true',
          'Built-ins integrated with existing architecture',
          'Transitions planned with flooring and trim profiles',
        ],
      },
      {
        heading: 'Delivery approach',
        items: [
          'Material selection confirmed before fabrication',
          'Mock-ups where alignment is critical',
          'Installed with protected finishes and clean site standards',
        ],
      },
    ],
  },
  '/repairs-upgrades': {
    title: 'Repairs, Upgrades & Phased Work',
    intro:
      'Targeted improvements and phased renovations planned to integrate cleanly with future work and long-term goals.',
    sections: [
      {
        heading: 'Typical scopes',
        items: [
          'Targeted repairs tied to future phases',
          'System and finish upgrades coordinated with existing conditions',
          'Prep work that keeps the next phase efficient',
        ],
      },
      {
        heading: 'Planning mindset',
        items: [
          'Scope designed to avoid rework later',
          'Schedules aligned to material readiness',
          'Documentation for continuity into the next phase',
        ],
      },
    ],
  },
  '/terms': {
    ...
    intro:
      'These terms outline how Helix Craftworks engages with site visitors and prospective clients. Please review before contacting us.',
    sections: [
      {
        heading: 'Use of this site',
        items: [
          'Content is informational and may change without notice',
          'No warranties are expressed or implied for site accuracy',
          'Do not reuse images or copy without permission',
        ],
      },
      {
        heading: 'Engagements',
        items: [
          'Work is governed by executed contracts and approved scopes',
          'Schedules and pricing are finalized in written agreements',
      ...
      },
      {
        heading: 'Liability',
        items: [
          'Helix is not responsible for third-party sites linked here',
          'We are not liable for losses arising from site use',
  ...
  '/privacy': {
    ...
    intro:
      'We collect only the information needed to respond to project inquiries and operate this site. We do not sell your data.',
    sections: [
      {
        heading: 'Information collected',
        items: [
          'Contact form details you provide (name, email, project context)',
          'Basic site analytics to improve usability',
          'No sensitive personal data is requested',
        ],
      },
      {
        heading: 'How we use it',
        items: [
          'To respond to your inquiry and plan project discussions',
          'To maintain site security and performance',
          'To improve our communication and scheduling workflows',
        ],
      },
      {
        heading: 'Sharing',
        items: [
          ...
          'Vendors receive data only when needed to service your request and subject to confidentiality',
          'You may request deletion of your submitted information',
        ],
      },
    ],
  },
        ...
        <main className="mt-16 flex flex-col gap-12 sm:gap-16">
            ...
            <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr]">
              <div className="space-y-6">
                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-steel">
                  Helix Services - Maintenance and repairs
                </p>
                <h1 className="font-display text-4xl font-semibold leading-tight text-canvas sm:text-5xl">
                  Maintenance for the systems that keep your space stable.
                </h1>
                <p className="max-w-2xl text-sm text-steel">
                  A calm, systems-first service practice from the same team that builds Helix
                  Craftworks projects. We plan visits, document status, and keep each system
                  predictable—without promising speed we cannot deliver.
                </p>
                <div className="flex flex-wrap gap-3 text-xs font-semibold uppercase tracking-[0.18em] text-steel">
                  <span className="rounded-full border border-canvas/10 bg-canvas/5 px-3 py-2">
                    HVAC and airflow
                  </span>
                  <span className="rounded-full border border-canvas/10 bg-canvas/5 px-3 py-2">
                ...
                <p className="text-xs text-steel">
                  Veteran-owned. Led by the same leadership as Helix Craftworks.
                </p>
              </div>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {[
                  ...
                  <article
                    key={card.title}
                    className="rounded-2xl border border-canvas/10 bg-slate-800/80 p-4 shadow-card"
                  >
          ...
          <section className="space-y-6 rounded-3xl border border-canvas/10 bg-canvas/5 p-8 shadow-card shadow-glow/30 sm:p-10">
            <SectionHeading
              ...
              copy="Coverage focused on the systems that run the space."
            />
              ...
              {[
                {
                  ...
                  items: [
                    'Seasonal readiness for heating and cooling',
                    'Zoned controls and damper checks',
                    'Condensate routes inspected and cleared',
                  ],
                },
                {
                  title: 'Mechanical Systems Oversight',
                  items: [
                    'Fans, pumps, and venting observations',
                    'Equipment condition and access notes',
                    'Safety and clearance checks where accessible',
                  ],
                },
                {
                  title: 'Electrical and Control Inspections',
                  items: [
                    'Panel label sanity checks',
                    'Disconnects and safety observations',
                    'Low-voltage and control board status review',
                  ],
                },
                {
                  title: 'Preventive Maintenance for Helix-Built or Modified Work',
                  items: [
                    'Scopes aligned to installed systems',
                    'Finish protection and access documented',
                    'Recommendations tied to the original build plan',
                  ],
                },
                {
                  title: 'Facilities Documentation and System Records',
                  items: [
                    'Visit notes and photos stored',
                    'Access details retained for future visits',
                    'Recommendations tracked for next steps',
                  ],
                },
                {
                  title: 'Priority Response and On-Call Support',
                  items: [
                    'Scheduling based on safety and capacity',
                    'Upgrade path for faster response when available',
                    'Direct contact path with the service lead',
                  ],
                },
              ].map((block) => (
                <article
                  key={block.title}
                  className="rounded-2xl border border-canvas/10 bg-charcoal/70 p-5 shadow-card"
                >
          ...
          <section className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
            <article className="space-y-4 rounded-3xl border border-canvas/10 bg-charcoal/80 p-6 shadow-card">
              <SectionHeading
                eyebrow="Approach"
                title="How we work"
                copy="Calm, orderly visits with clear scope."
              />
              <div className="grid gap-4 md:grid-cols-2">
                {[
                  {
                    label: 'Planning',
                    desc: 'Scope and access confirmed before we arrive, including ladders, roof, and finish-sensitive areas.',
                  },
                  {
                    label: 'Diagnostics',
                    desc: 'Root-cause checks with system protection first; we avoid quick fixes that create later risk.',
                  },
                  {
                    label: 'Coordination',
                    desc: 'If a trade partner is needed, we align visits to minimize disruption and duplication.',
                  },
                  {
                    label: 'Follow-through',
                    desc: 'Notes after each visit so future upgrades and seasonal checks stay predictable.',
                  },
                ].map((item) => (
                  <div
                    key={item.label}
                    className="rounded-xl border border-canvas/10 bg-canvas/5 p-4 text-sm text-steel"
                  >
            ...
            <article className="space-y-4 rounded-3xl border border-canvas/10 bg-canvas/5 p-6 shadow-card">
              <SectionHeading
                ...
                copy="Examples of how we structure visits."
              />
              <div className="grid gap-4 md:grid-cols-2">
            ...
            <article className="rounded-3xl border border-canvas/10 bg-canvas/5 p-6 shadow-card">
              ...
              <ul className="mt-3 space-y-2 text-sm text-steel">
                <li className="flex gap-2">
                  <span className="text-sky-300">-</span>
                  <span>Status notes after each visit with recommended next steps</span>
                </li>
                <li className="flex gap-2">
                  <span className="text-sky-300">-</span>
                  <span>Photos where helpful, plus access details for future visits</span>
                </li>
                <li className="flex gap-2">
                  <span className="text-sky-300">-</span>
                  <span>
                    Realistic scheduling; no emergency promises or pricing talk on this page
                  </span>
                </li>
              </ul>
            </article>
          ...
          <section
            id="contact"
            className="rounded-3xl border border-canvas/10 bg-gradient-to-br from-slate-900 via-slate-800 to-charcoal p-8 shadow-glow sm:p-10"
          >
            <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr]">
              <div className="space-y-4">
                ...
                <p className="text-sm text-steel">
                  Use the nav request link or the options below. We respond with a realistic
                  schedule based on current capacity.
                </p>
                <div className="space-y-2 text-sm text-steel">
                  <p>
                    Email:{' '}
                    <a className="text-sky-200 underline" href="mailto:chris@helixcraftworks.com">
                      chris@helixcraftworks.com
                    </a>
                  </p>
                  <p>
                    Client Hub:{' '}
                  ...
                  <p>
                    Share the systems involved, access notes, and timing. We will confirm next
                    steps.
                  </p>
                </div>
              </div>
      ...
      <Shell>
        ...
        <main className="mt-16 flex flex-col gap-12 sm:gap-16">
          <section className="space-y-6 rounded-2xl border border-canvas/10 bg-canvas/5 p-8 shadow-card shadow-glow/30">
            ...
            <h1 className="font-display text-3xl font-semibold text-canvas sm:text-4xl">
              {standalonePage.title}
            </h1>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {standalonePage.sections.map((section) => (
                <article
                  key={section.heading}
                  className="rounded-xl border border-canvas/10 bg-charcoal/60 p-5 shadow-card"
                >
                  <h2 className="font-display text-lg font-semibold text-canvas">
                    {section.heading}
                  </h2>
                  <ul className="mt-3 space-y-2 text-sm text-steel">
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (response.ok || (response.status >= 300 && response.status < 400)) {
        setStatus('success');
        setProjectType(
          path === '/helix-services' ? 'Preventive maintenance' : DEFAULT_PROJECT_TYPE
        );
        ...
        setStatus('error');
        setErrorMessage(
          `Something went wrong. Status ${response.status}. Please try again or email chris@helixcraftworks.com.`
        );
      }
    } catch (error) {
      console.error(error);
    ...
    <div className="min-h-screen bg-charcoal text-canvas">
      ...
      <div className="mx-auto flex min-h-screen max-w-6xl flex-col px-6 pb-16 pt-10 sm:px-10 sm:pt-14 lg:px-14">
        ...
        <main id="top" className="flex flex-col gap-16 sm:gap-20">
          <section className="mt-16 grid items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="space-y-8">
              ...
              <p className="max-w-2xl text-lg text-steel">
                Delivering residential renovations through disciplined planning and finish-forward
                execution.
              </p>
              <div className="flex flex-wrap gap-3 text-sm text-steel">
                <span className="rounded-full border border-canvas/10 px-3 py-2">
            ...
            <div className="relative overflow-hidden rounded-2xl border border-canvas/10 bg-canvas/5 p-6 shadow-card">
              <div
                className="absolute inset-0 bg-gradient-to-br from-canvas/5 via-redwood/10 to-transparent"
                aria-hidden
              />
              <div className="relative space-y-6">
                <div className="flex items-center justify-between gap-3">
                  <div>
                    ...
                    <p className="font-display text-xl font-semibold text-canvas">
          ...
          <section
            id="specialty-work"
            className="space-y-6 rounded-2xl border border-canvas/10 bg-canvas/5 p-6 shadow-card shadow-glow/30"
          >
            <SectionHeading
            ...
            <p className="text-sm text-steel">
              Integrated into the renovation. Never treated as a standalone feature.
            </p>
          </section>
          ...
          >
            <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
              <div className="space-y-5">
                ...
                <p className="text-sm text-steel">
                  We reply within one business day. This form goes straight to the project lead at{' '}
                  {BRAND_MARK}. Share scope, rough dimensions, timing, and any inspiration. We'll
                  come back with next steps and a plan.
                </p>
                ...
                <div className="flex flex-col text-xs text-steel">
                  ...
                  <span className="mt-1 text-[11px]">
                    Already a client? Log in to Client Hub to make a request.
                  </span>
                </div>
              </div>
              ...
              >
                ...
                <input
                  type="hidden"
                  name="leadType"
                  value={isServicesLead ? 'Helix Services' : 'Helix Craftworks'}
                />
                <p className="hidden">
                  <label>
                ...
                <p className="text-xs text-steel">
                  By submitting, you agree to let us contact you about this request. We keep
            ...
            <div className="space-y-4">
              <article className="rounded-2xl border border-canvas/10 bg-canvas/5 p-5 shadow-card">
                ...
                <ul className="mt-3 space-y-2 text-sm text-steel">
                  <li>
                    <a href="/careers" className="text-redwood">
                      Careers
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="mailto:chris@helixcraftworks.com" className="text-redwood">
                      General email
                    </a>
                  </li>
                </ul>
              ...
              <article className="rounded-2xl border border-canvas/10 bg-charcoal/60 p-5 shadow-card">
                <h3 className="font-display text-lg font-semibold text-canvas">
                  Helix Craftworks vs. Helix Services
                </h3>
                <p className="mt-2 text-xs text-steel">
                  Project builds stay with Helix Craftworks. Preventive maintenance and repairs run
                  through Helix Services.
                </p>
                <ul className="mt-3 space-y-2 text-sm text-steel">
                  <li className="flex gap-2">
                    <span className="text-redwood">-</span>
                    <span>Helix Craftworks: renovations, remodels, sequencing, finish work.</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-redwood">-</span>
                    <span>Helix Services: preventive maintenance plans and service visits.</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-redwood">-</span>
                    <span>Same leadership, tailored workflows for each type of request.</span>
                  </li>
                </ul>
              </article>
            </div>
          ...
          <section className="space-y-6">
            <SectionHeading
              ...
              copy="Quick notes on timelines, scope, and collaboration."
            />
